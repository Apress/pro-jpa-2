...
public class DepartmentServiceServlet extends HttpServlet {
    ...
    private final String DESCRIPTION = 
        "This example demonstrates EJBContext lookup of a dependency. </br>" +
        ...
        "looks up another SLSB using the dependency is defined using the @EJB " +
        "annotation. The example is identical to the previous one, except that the SLSB " +
        "uses an EJBContext instead of an InitialContext for the lookup.";
